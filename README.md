<p align="center">
	<a href="#"  target="_blank" title="Visite CorporatiX">
		<img src="/public/image/readme/corporatix-brand-v-white-720.png" alt="Sistema CMS CorporatiX" width="340px">
	</a>
</p>
...
- [RF030]                       O sistema deverá ter a funcionalidade de `exportação` de dados em formato `Excel ou PDF` nas entidades cargos, categorias, notícias, pedidos de solicitação, questionários, unidades e usuários. https://filamentphp.com/docs/3.x/actions/prebuilt-actions/export#overview
...
<p align="center">
	<a href="#"  target="_blank" title="logo">
		<img src="/public/image/readme/corporatix-brand-h-white-480.png" alt="logo" width="180">
	</a>
</p>
